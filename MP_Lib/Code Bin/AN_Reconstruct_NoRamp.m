...
function [OutPut] = AN_Reconstruct_NoRamp(an_data_files, channel)
...
if nargin==2
    multiplied_zc_cell = AN_Reconstruct_GenerateSignal_eachChannel_NoRamp(an_data_files, delay_zc_cell, channel);
else
    multiplied_zc_cell = AN_Reconstruct_GenerateSignal_eachChannel_NoRamp(an_data_files, delay_zc_cell);
end
