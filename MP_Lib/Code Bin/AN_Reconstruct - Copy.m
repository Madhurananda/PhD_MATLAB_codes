...
if nargin==2
    [multiplied_zc_cell, TotalNoSpikes, TotalSortedNoSpikes] = AN_Reconstruct_GenerateSignal_eachChannel(an_data_files, delay_zc_cell, channel);
else
    [multiplied_zc_cell, TotalNoSpikes, TotalSortedNoSpikes] = AN_Reconstruct_GenerateSignal_eachChannel(an_data_files, delay_zc_cell);
end
