...
function [AN,bmSig] = AN_Sig_Recon_FromFilterbank_FromSpike(calling_mode,sig_name_mono,spike_option,save_option,bm_option,plot_option,norm_option,varargin)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
wavwrite(bmSig(1,:),44100,16,'bmsig_1.wav');
wavwrite(bmSig(45,:),44100,16,'bmsig_45.wav');

disp(' ')
disp(' ')
disp('Filterbank Re-Construction complete.');
disp('');
...
% This function has been called to produce the reconstructed signal.
AN_Reconstruct_NoRamp_NoSpikeCap(output_filename)
