function [ OutPut ] = Spectrogram_Compare_Reconstruct( sig_name_mono)
...
title('The original Signal Spectrogram')
view(0,90);
...
title('The Re-constructed Signal Spectrogram')
view(0,90);
xlabel('Time (Seconds)'); ylabel('Hz');
...
title('The Re-constructed Signal')
xlabel('Time (Seconds)'); ylabel('Amplitude');
grid on
